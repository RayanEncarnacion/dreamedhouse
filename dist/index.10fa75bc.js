...
var _overlayMenu = require("../jsModules/overlayMenu");
var _overlayMenuDefault = parcelHelpers.interopDefault(_overlayMenu);
var _hideScrollText = require("../jsModules/hideScrollText");
var _hideScrollTextDefault = parcelHelpers.interopDefault(_hideScrollText);
var _cardsAnimations = require("../jsModules/cardsAnimations");
var _cardsAnimationsDefault = parcelHelpers.interopDefault(_cardsAnimations);
_overlayMenuDefault.default();
_hideScrollTextDefault.default();
_cardsAnimationsDefault.default();
...
},{"../jsModules/overlayMenu":"jLVlC","../jsModules/hideScrollText":"9JTKH","../jsModules/cardsAnimations":"g3HTp","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"jLVlC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const menuTransition = ()=>// if is visible, hide it and viceversa
    overlayMenu.style.transform === `translateX(105%)` || overlayMenu.style.transform === '' ? overlayMenu.style.transform = 'translateX(0)' : overlayMenu.style.transform = ''
;
function menuInit() {
...
},{}],"9JTKH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const navObserver = new IntersectionObserver(hideScrollText, {
    root: null,
    threshold: 0
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"g3HTp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const allCards = document.querySelectorAll('.flex-card, .services-card, .agent-card');
// Containers
...
const animateServices = ()=>{
    _gsap.gsap.fromTo('.services-card', {
        y: 100
    }, {
        y: 0,
        opacity: 1,
...
const animateCards = (e)=>{
    ...
    currentContainer === 'how' ? animateHow() : currentContainer === 'services' ? animateServices() : currentContainer === 'agents' && animateAgents();
};
...
},{"./gsap-core.js":"3CNdC","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["5MabY","g1M29"], "g1M29", "parcelRequireac7d")
